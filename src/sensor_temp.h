...
tft.print(water_temp_C,1);tft.print((char)223);tft.print("C"); 
tft.setCursor(sensor_description_position,100); tft.println("WATER");  
...
void getDHTReadings(){
  ...
  tft.print(dht_tempC,1); tft.print((char)223); tft.println("C");
  tft.setCursor(sensor_description_position,130); tft.print("AIR"); 
  tft.setCursor(0,160);
  tft.print(dht_humidity,0); tft.println("%");
  tft.setCursor(sensor_description_position,160); tft.println("HUM");
